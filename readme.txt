=== Bbuilds NYT Book API Demo Block ===
...
An demo block using NYT Books API.
...
1. Upload the plugin files to the `/wp-content/plugins/bbuilds-nyt-demo` directory, or install the plugin through the WordPress plugins screen directly.
